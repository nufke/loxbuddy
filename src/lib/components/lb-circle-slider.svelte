...
<div class="w-full flex align-center justify-center">
	<svg role="button" tabindex="0" width="320" height="320" onmouseup={mouseUp} onmousemove={mouseMove}>
		<circle class="track" role="button" tabindex="0" cx={loc.x} cy={loc.y} r={radius} onmousedown={trackMouseDown}/>
		<circle class="set" cx={set.x} cy={set.y} r="12"/>
		<circle class="knob" role="button" tabindex="0" cx={knob.x} cy={knob.y} r="12" onmousedown={knobMouseDown}/>
		...
		<svg class="button" role="button" tabindex="0" x="105" y="260" onmousedown={startDown} onmouseup={endDown}>
			<circle cx="20" cy="20" r="20" fill="black"/>
			<path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none" stroke="currentColor" d="m14 17 6 6 6-6"></path>
		</svg>
		<svg class="button" role="button" tabindex="0" x="175" y="260" onmousedown={startUp} onmouseup={endUp}>
			<circle cx="20" cy="20" r="20" fill="black"/>
