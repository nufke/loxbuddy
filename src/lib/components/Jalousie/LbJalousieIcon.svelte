<script lang="ts">
	...
	let iconColor = $derived(isLocked ? 'stroke-warning-500' : (screenPosition > 0) ? 'dark:stroke-primary-500 stroke-primary-700' : 'dark:stroke-surface-50 stroke-surface-950');
