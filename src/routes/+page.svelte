			...
			<Dialog.Content class="card bg-surface-100-900 p-4 pt-3 shadow-sm rounded-lg border border-white/5 hover:border-white/10
				...
				<Dialog.Description>
						...
						<div class="w-full flex justify-center items-center p-3">
							<p>{$_("Connecting to Miniserver")}...</p>
						</div>
				</Dialog.Description>
				<div class="flex justify-center pt-4">
					<Dialog.CloseTrigger class="btn btn-md dark:bg-surface-950 bg-surface-50 shadow-sm rounded-lg border border-white/15 hover:border-white/50">{$_("Cancel")}</Dialog.CloseTrigger>
				</div>
			</Dialog.Content>
		</Dialog.Positioner>
	</Portal>
